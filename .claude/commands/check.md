...
4. Run `pnpm run lint` in `vscode-extension/` to check VS Code extension code quality
5. Run `pnpm run build` in `vscode-extension/` to compile the VS Code extension
6. Review CLAUDE.md and README.md against the current codebase — verify that commands, module descriptions, and tool lists are accurate and up-to-date. Flag any discrepancies.
